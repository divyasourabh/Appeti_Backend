...
<!--<![endif]-->
<head>
<title>Terms and Conditions - Appeti</title>
</head>
<body
	...
	<div id="top" class="site">
		...
		<div class="x-container max width offset">
			<div class="x-main full" role="main">
				...
				<article id="post-527"
					class="post-527 page type-page status-publish hentry no-post-thumbnail">


					<div class="entry-content content">


						<h2 class="h-custom-headline center-text h3 accent">
							<span>Terms and Conditions of Service</span>
						</h2>
						<hr class="x-gap" style="margin: 1.313em 0 0 0;">
						<p>
							Welcome to <a href="${pageContext.request.contextPath}">Appeti.in</a>. Your
							use of the website and services &amp; tools are governed by the
							following Terms &amp; Conditions which together with our Privacy
							Policy are governed by following terms and condition. By mere use
							of the website You shall be contracting with Millionaire Infotech
							Pvt. Ltd, a company incorporated under Companies Act, 1956 with
							CIN Number: U72300MH2011PTC223911 and registered office at B-1/3,
							Emca House, 289, SBS Marg, Fort, Mumbai-400001, India and these
							terms and conditions constitute your binding obligations.
						</p>
						<p>This website is operated by Appeti.in. Throughout the site,
							the terms "we", "us" and "our" refer to Appeti.in. Appeti.in
						...
						<p>We reserve the right to refuse service to anyone for any
							reason at any time.</p>
						<p>You understand that your content (not including credit card
						...
						<p>The headings used in this agreement are included for
							...
							Terms.</p>
						<h4>SECTION&nbsp;2&nbsp;- ACCURACY, COMPLETENESS AND
							TIMELINESS OF INFORMATION</h4>
						<p>We are not responsible if information made available on
							...
							this site is at your own risk.</p>
						<p>This site may contain certain historical information.
						...
						<h4>SECTION&nbsp;3&nbsp;- MODIFICATIONS TO THE SERVICE AND
							PRICES</h4>
						...
						<p>We reserve the right at any time to modify or discontinue
							...
							any time.</p>
						<p>We shall not be liable to you or to any third-party for any
							modification, price change, suspension or discontinuance of the
							Service.</p>
						<h4>SECTION&nbsp;4&nbsp;- PRODUCTS OR SERVICES (if
							applicable)</h4>
						<p>We have made every effort to display as accurately as
						...
						<p>We reserve the right, but are not obligated, to limit the
						...
						<p>We do not warrant that the quality of any products,
							...
							you will meet your expectations, or that any errors in the
							Service will be corrected.</p>
						<h4>SECTION&nbsp;5&nbsp;- ACCURACY OF BILLING AND ACCOUNT
							INFORMATION</h4>
						...
						<h4>SECTION&nbsp;6&nbsp;- OPTIONAL TOOLS</h4>
						<p>We may provide you with access to third-party tools over
							which we neither monitor nor have any control nor input.</p>
						<p>You acknowledge and agree that we provide access to such
						...
						<p>Any use by you of optional tools offered through the site
						...
						<p>We may also, in the future, offer new services and/or
							features through the website (including, the release of new tools
							and resources). Such new features and/or services shall also be
						...
						<p>Certain content, products and services available via our
							Service may include materials from third-parties.</p>
						...
						<p>We are not liable for any harm or damages related to the
							...
							third-party.</p>
						<h4>SECTION&nbsp;8&nbsp;- USER COMMENTS, FEEDBACK AND OTHER
							SUBMISSIONS</h4>
						<p>If, at our request, you send certain specific submissions
							...
							or (3) to respond to any comments.</p>
						<p>We may, but have no obligation to, monitor, edit or remove
						...
						<p>You agree that your comments will not violate any right of
						...
						<h4>SECTION&nbsp;9&nbsp;- PERSONAL INFORMATION</h4>
						<p>
							Your submission of personal information through the store is
							governed by our Privacy Policy. To view our&nbsp;<a
								href="${pageContext.request.contextPath}/privacy-policy/" target="_blank">Privacy
								Policy.</a>
						</p>
						...
						<p>Occasionally there may be information on our site or in the
							...
							after you have submitted your order).</p>
						<p>We undertake no obligation to update, amend or clarify
						...
						<p>In addition to other prohibitions as set forth in the Terms
							...
							prohibited uses.</p>
						<h4>SECTION 12&nbsp;- DISCLAIMER OF WARRANTIES; LIMITATION OF
							LIABILITY</h4>
						<p>We do not guarantee, represent or warrant that your use of
							our service will be uninterrupted, timely, secure or error-free.</p>
						<p>We do not warrant that the results that may be obtained
							from the use of the service will be accurate or reliable.</p>
						<p>You agree that from time to time we may remove the service
							for indefinite periods of time or cancel the service at any time,
							without notice to you.</p>
						<p>You expressly agree that your use of, or inability to use,
							the service is at your sole risk. The service and all products
							...
							non-infringement.</p>
						<p>In no case shall Appeti.in, our directors, officers,
						...
						<p>You agree to indemnify, defend and hold harmless Appeti.in
						...
						<p>The obligations and liabilities of the parties incurred
							...
							this agreement for all purposes.</p>
						<p>These Terms of Service are effective unless and until
						...
						<p>If in our sole judgment you fail, or we suspect that you
						...
						<p>These Terms of Service and any policies or operating rules
						...
						<p>Any ambiguities in the interpretation of these Terms of
							Service shall not be construed against the drafting party.</p>
						<h4>SECTION 17&nbsp;- GOVERNING LAW</h4>
						<p>These Terms of Service and any separate agreements whereby
							we provide you Services shall be governed by and construed in
							accordance with the laws of&nbsp;Indian Government.</p>
						<h4>SECTION 18&nbsp;- CHANGES TO TERMS OF SERVICE</h4>
						<p>You can review the most current version of the Terms of
							Service at any time at this page.</p>
						<p>We reserve the right, at our sole discretion, to update,
							change or replace any part of these Terms of Service by posting
							updates and changes to our website. It is your responsibility to
							check our website periodically for changes. Your continued use of
							or access to our website or the Service following the posting of
