...
jQuery(document).ready(function(t) {
        ...
        }, t(".x-accordion-toggle[data-parent]").click(function() {
    ...
    function(t, e) {
        ...
        i = {
            ...
            processElements: function() {
                $elements = e("[data-x-element]").each(function(t, i) {
                    if (!e(i).data("x-initialized")) {
                        var a = e(i).data("x-params") || {};
                        callback = n.lookupCallback(e(i).data("x-element")), callback(i, a), e(i).data("x-initialized", !0)
                    }
                })
            },
    ...
    }(xData, jQuery), jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        def: "easeOutQuad",
        ...
        easeInElastic: function(t, e, n, i, a) {
            ...
            return -(s * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * a - o) * Math.PI / r)) + n
        },
        easeOutElastic: function(t, e, n, i, a) {
            ...
            return s * Math.pow(2, -10 * e) * Math.sin(2 * (e * a - o) * Math.PI / r) + i + n
        },
        easeInOutElastic: function(t, e, n, i, a) {
            ...
            return 1 > e ? -.5 * s * Math.pow(2, 10 * (e -= 1)) * Math.sin(2 * (e * a - o) * Math.PI / r) + n : s * Math.pow(2, -10 * (e -= 1)) * Math.sin(2 * (e * a - o) * Math.PI / r) * .5 + i + n
        },
        ...
        easeOutBounce: function(t, e, n, i, a) {
            return (e /= a) < 1 / 2.75 ? 7.5625 * i * e * e + n : 2 / 2.75 > e ? i * (7.5625 * (e -= 1.5 / 2.75) * e + .75) + n : 2.5 / 2.75 > e ? i * (7.5625 * (e -= 2.25 / 2.75) * e + .9375) + n : i * (7.5625 * (e -= 2.625 / 2.75) * e + .984375) + n
        },
        ...
        t.flexslider = function(e, n) {
            ...
            t.data(e, "flexslider", i), v = {
                init: function() {
                    ...
                    }), i.vars.pauseInvisible && v.pauseInvisible.isHidden() || (i.vars.initDelay > 0 ? i.startTimeout = setTimeout(i.play, i.vars.initDelay) : i.play())), h && v.asNav.setup(), s && i.vars.touch && v.touch(), (!f || f && i.vars.smoothHeight) && t(window).bind("resize orientationchange focus", v.resize), i.find("img").attr("draggable", "false"), setTimeout(function() {
                        i.vars.start(i)
                    }, 200)
                },
                asNav: {
                ...
                directionNav: {
                    setup: function() {
                        ...
                        i.controlsContainer ? (t(i.controlsContainer).append(e), i.directionNav = t("." + o + "direction-nav li a", i.controlsContainer)) : (i.append(e), i.directionNav = t("." + o + "direction-nav li a", i)), v.directionNav.update(), i.directionNav.bind(l, function(e) {
                            e.preventDefault();
                            var n;
                            ("" === c || c === e.type) && (n = i.getTarget(t(this).hasClass(o + "next") ? "next" : "prev"), i.flexAnimate(n, i.vars.pauseOnAction)), "" === c && (c = e.type), v.setToClearWatchedEvent()
                        })
                    },
                    update: function() {
                        var t = o + "disabled";
                ...
                touch: function() {
                    function t(t) {
                        i.animating ? t.preventDefault() : (window.navigator.msPointerEnabled || 1 === t.touches.length) && (i.pause(), m = u ? i.h : i.w, y = Number(new Date), b = t.touches[0].pageX, x = t.touches[0].pageY, v = p && d && i.animatingTo === i.last ? 0 : p && d ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : p && i.currentSlide === i.last ? i.limit : p ? (i.itemW + i.vars.itemMargin) * i.move * i.currentSlide : d ? (i.last - i.currentSlide + i.cloneOffset) * m : (i.currentSlide + i.cloneOffset) * m, c = u ? x : b, h = u ? b : x, e.addEventListener("touchmove", n, !1), e.addEventListener("touchend", a, !1))
                    }

                    function n(t) {
                        b = t.touches[0].pageX, x = t.touches[0].pageY, g = u ? c - x : c - b, w = u ? Math.abs(g) < Math.abs(b - h) : Math.abs(g) < Math.abs(x - h);
                        var e = 500;
                        (!w || Number(new Date) - y > e) && (t.preventDefault(), !f && i.transitions && (i.vars.animationLoop || (g /= 0 === i.currentSlide && 0 > g || i.currentSlide === i.last && g > 0 ? Math.abs(g) / m + 2 : 1), i.setProps(v + g, "setTouch")))
                    }
                    ...
                    function a() {
                        if (e.removeEventListener("touchmove", n, !1), i.animatingTo === i.currentSlide && !w && null !== g) {
                            ...
                            i.canAdvance(o) && (Number(new Date) - y < 550 && Math.abs(t) > 50 || Math.abs(t) > m / 2) ? i.flexAnimate(o, i.vars.pauseOnAction) : f || i.flexAnimate(i.currentSlide, i.vars.pauseOnAction, !0)
                        }
                        e.removeEventListener("touchend", a, !1), c = null, h = null, g = null, v = null
                    }
                    ...
                    function s(t) {
                        ...
                        if (n) {
                            var i = -t.translationX,
                                a = -t.translationY;
                            return S += u ? a : i, g = S, w = u ? Math.abs(S) < Math.abs(-i) : Math.abs(S) < Math.abs(-a), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                                e._gesture.stop()
                            }) : void((!w || Number(new Date) - y > 500) && (t.preventDefault(), !f && n.transitions && (n.vars.animationLoop || (g = S / (0 === n.currentSlide && 0 > S || n.currentSlide === n.last && S > 0 ? Math.abs(S) / m + 2 : 1)), n.setProps(v + g, "setTouch"))))
                        }
                    }
                    ...
                    function l(t) {
                        ...
                        if (e) {
                            if (e.animatingTo === e.currentSlide && !w && null !== g) {
                                ...
                                e.canAdvance(i) && (Number(new Date) - y < 550 && Math.abs(n) > 50 || Math.abs(n) > m / 2) ? e.flexAnimate(i, e.vars.pauseOnAction) : f || e.flexAnimate(e.currentSlide, e.vars.pauseOnAction, !0)
                            }
                            c = null, h = null, g = null, v = null, S = 0
                        }
                    }
                    var c, h, v, m, g, y, w = !1,
                        b = 0,
                ...
                resize: function() {
                    !i.animating && i.is(":visible") && (p || i.doMath(), f ? v.smoothHeight() : p ? (i.slides.width(i.computedW), i.update(i.pagingCount), i.setProps()) : u ? (i.viewport.height(i.h), i.setProps(i.h, "setTotal")) : (i.vars.smoothHeight && v.smoothHeight(), i.newSlides.width(i.computedW), i.setProps(i.computedW, "setTotal")))
                },
                ...
                if (i.vars.animationLoop || e === i.currentSlide || (i.direction = e > i.currentSlide ? "next" : "prev"), h && 1 === i.pagingCount && (i.direction = i.currentItem < e ? "next" : "prev"), !i.animating && (i.canAdvance(e, l) || a) && i.is(":visible")) {
                    if (h && r) {
                    ...
                    if (i.animating = !0, i.animatingTo = e, n && i.pause(), i.vars.before(i), i.syncExists && !l && v.sync("animate"), i.vars.controlNav && v.controlNav.active(), p || i.slides.removeClass(o + "active-slide").eq(e).addClass(o + "active-slide"), i.atEnd = 0 === e || e === i.last, i.vars.directionNav && v.directionNav.update(), e === i.last && (i.vars.end(i), i.vars.animationLoop || i.pause()), f) s ? (i.slides.eq(i.currentSlide).css({
                        opacity: 0,
                        zIndex: 1
                    }), i.slides.eq(e).css({
                        opacity: 1,
                        ...
                        var m, g, y, w = u ? i.slides.filter(":first").height() : i.computedW;
    ...
    function() {
        ...
        ! function(t, e) {
            ...
            var a, o, r, s, l, c, u, d, p, f, h, v, m, g, y, w;
            return a = n(i), d = t.call(i, "ontouchstart") >= 0, s = {
                horizontal: {},
                vertical: {}
            }, l = 1, u = {}, c = "waypoints-context-id", h = "resize.waypoints", v = "scroll.waypoints", m = 1, g = "waypoints-waypoint-ids", y = "waypoint", w = "waypoints", o = function() {
                function t(t) {
                    var e = this;
        ...
        n.VERSION = "3.2.0", n.DEFAULTS = {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                if (l) {
                    ...
                    r = "bottom" == r && c.top + c.height + d - h.scroll > h.height ? "top" : "top" == r && c.top - h.scroll - d < 0 ? "bottom" : "right" == r && c.right + u > h.width ? "left" : "left" == r && c.left - u < h.left ? "right" : r, a.removeClass(p).addClass(r)
                }
    ...
    function(t) {
        xData.api.map("google_map_marker", function(t, e) {
            console.log("Map Marker Added: [LAT:" + e.lat + ",LNG:" + e.lng + "]")
        }), xData.fn.setMarkers = function(e, n) {
            var i = [],
                a = [],
                o = t("#" + n).parent().attr("id");
            t("#" + o + " .x-google-map-marker").each(function(n, o) {
                ...
                i[n] = new google.maps.Marker({
                    ...
                    infoWindowIndex: n,
                    icon: r.image
                }), a[n] = new google.maps.InfoWindow({
                    content: r.markerInfo,
                    maxWidth: 200
                }), google.maps.event.addListener(i[n], "click", function() {
                    "" !== r.markerInfo && a[n].open(e, this)
                })
            })
        }, xData.api.map("google_map", function(e, n) {
            var i = t(e).find(".x-google-map-inner"),
                a = i.attr("id"),
                o = n.lat,
                r = n.lng,
                s = new google.maps.LatLng(o, r),
                l = n.drag,
                c = parseInt(n.zoom),
                u = n.zoomControl,
                d = n.hue,
                ...
                h = new google.maps.StyledMapType(p, {
                    name: "Styled Map"
                }),
                v = new google.maps.Map(document.getElementById(a), f);
            v.mapTypes.set("map_style", h), v.setMapTypeId("map_style"), xData.fn.setMarkers && xData.fn.setMarkers(v, a)
        }), xData.api.map("skill_bar", function(e, n) {
        ...
        }), xData.api.map("extra", function(e, n) {
            if ("tooltip" == n.type) {
                var i = {
                    animation: !0,
                    html: !1,
                ...
                n.title && "" !== n.title && (i.title = n.title), t(e).tooltip(i)
            } else {
                var i = {
                    animation: !0,
                    html: !1,
                ...
                n.title && "" !== n.title && (i.title = n.title), t(e).popover(i)
            }
        }), jQuery(document).ready(function(t) {
            ...
            t.each(["video/x-ms-wmv", "audio/x-ms-wma"], function(e, n) {
                ...
                success: function(n) {
                    var i = !0,
                        a = t(e).find(".mejs-container"),
                        o = t(e).find(".mejs-controls"),
                        r = function() {
                            o.stop().animate({
                                opacity: 1
                            }, 150)
                    ...
                    n.addEventListener("canplay", function() {
                        n.attributes.autoplay && i && (n.play(), i = !1), n.attributes.muted && n.setMuted(!0)
                    }), n.addEventListener("ended", function() {
                        n.attributes.loop && n.play()
                    }), a.hasClass("mejs-video") && (n.addEventListener("playing", function() {
                        a.hover(r, s)
                    }), n.addEventListener("pause", function() {
                        a.off("mouseenter mouseleave"), r()
                    }))
                },
                error: function() {
        ...
        }), xData.api.map("slider", function(t, e) {
            jQuery(window).load(function() {
                jQuery(t).flexslider({
                    ...
                    slideshowSpeed: e.slideTime,
                    animationSpeed: e.slideSpeed,
        ...
        }), xData.api.map("column", function(e, n) {
            n.fade && t(e).waypoint(function() {
                var e = {
                    opacity: "1"
                };
                "in-from-top" === n.animation ? e.top = "0" : "in-from-left" === n.animation ? e.left = "0" : "in-from-right" === n.animation ? e.right = "0" : "in-from-bottom" === n.animation && (e.bottom = "0"), t(this).animate(e, 750, "easeOutExpo")
            }, {
                offset: "65%",
                triggerOnce: !0
            })
        }), xData.api.map("recent_posts", function(e, n) {
            n.fade && t(e).waypoint(function() {
        ...
        }), xData.api.map("lightbox", function(t, e) {
            var n = {
                skin: "light",
                overlay: {
                    opacity: e.opacity,
            ...
            e.deeplink && (n.linkId = "gallery-image"), jQuery(e.selector).iLightBox(n)
        }), xData.api.map("content_band", function(e, n) {
            jQuery(window).load(function() {
                if (n.parallax && (Modernizr.touch ? t(e).css("background-attachment", "scroll") : ("image" == n.type && (speed = .1), "pattern" == n.type && (speed = .3), speed && t(e).parallaxContentBand("50%", speed))), "video" == n.type) {
                    var i = new jQuery.BigVideo;
                    i.init(), Modernizr.touch ? i.show(n.poster) : i.show(n.video, {
                        ambient: !0
                    })
                }
            })
        }), xData.api.map("responsive_text", function(e, n) {
            var i = {};
            "" !== n.minFontSize && (i.minFontSize = n.minFontSize), "" !== n.maxFontSize && (i.maxFontSize = n.maxFontSize), t(n.selector).fitText(n.compression, i)
        }), xData.api.map("counter", function(e, n) {
            t(e).waypoint(function() {
                t(this).find(".number").animateNumber({
                    number: n.numEnd
                }, n.numSpeed)
            }, {
                offset: "85%",
