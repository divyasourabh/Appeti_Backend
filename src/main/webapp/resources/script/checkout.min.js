...
jQuery(function(a) {
    ...
    var b = {
            ...
            update_checkout: function() {
                b.reset_update_checkout_timer(), b.updateTimer = setTimeout(b.update_checkout_action, "5")
            },
            update_checkout_action: function() {
                if (b.xhr && b.xhr.abort(), 0 !== a("form.checkout").size()) {
                    ...
                    var d, e, f, g, h, i, j = a("#order_review input[name=payment_method]:checked").val(),
                        k = a("#billing_country").val(),
                        l = a("#billing_state").val(),
                        m = a("input#billing_postcode").val(),
                        n = a("#billing_city").val(),
                        o = a("input#billing_address_1").val(),
                        p = a("input#billing_address_2").val();
                    ...
                    b.xhr = a.ajax({
                        ...
                        success: function(b) {
                            if (b && b.fragments && a.each(b.fragments, function(b, c) {
                                ...
                                a(".woocommerce-error, .woocommerce-message").remove(), c.prepend(b.messages ? b.messages : b), c.find(".input-text, select").blur(), a("html, body").animate({
                                    scrollTop: a("form.checkout").offset().top - 100
                                }, 1e3)
                            }
                            0 === a(".woocommerce-checkout").find("input[name=payment_method]:checked").size() && a(".woocommerce-checkout").find("input[name=payment_method]:eq(0)").attr("checked", "checked"), a(".woocommerce-checkout").find("input[name=payment_method]:checked").eq(0).trigger("click"), a("body").trigger("updated_checkout")
                        }
                    })
                }
            },
                    ...
                    1 != d["blockUI.isBlocked"] && c.block({
                        ...
                        success: function(b) {
                            ...
                            try {
                                ...
                                a(".woocommerce-error, .woocommerce-message").remove(), c.prepend(d.messages ? d.messages : b), c.removeClass("processing").unblock(), c.find(".input-text, select").blur(), a("html, body").animate({
                                    scrollTop: a("form.checkout").offset().top - 100
                                }, 1e3), "true" === d.refresh && a("body").trigger("update_checkout"), a("body").trigger("checkout_error")
                            }
                        },
                        dataType: "html"
                    })
