jQuery(document).ready(function(e) {
    function c(e) {
        e.addClass(a).siblings(u).removeClass(a);
        if (Modernizr.touch) {
            e.siblings(u).data(f, 0);
            e.find("." + a).removeClass(a).data(f, 0)
        }
    }

    function h(e) {
        e.find("." + a).removeClass(a)
    }

    function p(t) {
        clearTimeout(l.id);
        var n = e(t.target).closest("li");
        n.hasClass("menu-item-has-children") && c(n)
    }
    ...
    function v(t) {
        var n = e(t.target).closest("li");
        n.data(f, n.data(f) + 1);
        if (n.hasClass("menu-item-has-children") && n.data(f) === 1) {
            t.preventDefault();
            t.stopPropagation();
            c(n)
        }
    ...
    e(".x-slider-container.above .x-slider-scroll-bottom").click(function(t) {
        t.preventDefault();
        e("html, body").animate({
            scrollTop: e(".x-slider-container.above").outerHeight()
        }, 850, "easeInOutExpo")
    });
    e(".x-slider-container.below .x-slider-scroll-bottom").click(function(t) {
        t.preventDefault();
        var n = e(".masthead").outerHeight(),
            r = e(".x-navbar-fixed-top-active .x-navbar").outerHeight(),
            i = e(".x-slider-container.above").outerHeight(),
            s = e(".x-slider-container.below").outerHeight(),
            o = n + i + s - r;
        e("html, body").animate({
            scrollTop: o
        }, 850, "easeInOutExpo")
    ...
    !r.hasClass("page-template-template-blank-3-php") && !r.hasClass("page-template-template-blank-6-php") && !r.hasClass("page-template-template-blank-7-php") && !r.hasClass("page-template-template-blank-8-php") && (r.hasClass("x-boxed-layout-active") && r.hasClass("x-navbar-fixed-top-active") && r.hasClass("admin-bar") ? t.scroll(function() {
        var t = e("#wpadminbar").outerHeight(),
            r = s.offset().top - t,
            o = n.scrollTop();
        o >= r ? i.addClass("x-navbar-fixed-top x-container max width") : i.removeClass("x-navbar-fixed-top x-container max width")
        ...
        var e = s.offset().top,
            t = n.scrollTop();
        t >= e ? i.addClass("x-navbar-fixed-top x-container max width") : i.removeClass("x-navbar-fixed-top x-container max width")
    }) : r.hasClass("x-navbar-fixed-top-active") && t.scroll(function() {
        var e = s.offset().top,
            t = n.scrollTop();
        t >= e ? i.addClass("x-navbar-fixed-top") : i.removeClass("x-navbar-fixed-top")
    }));
    var o = e(".desktop .x-nav"),
        u = "li.menu-item-has-children",
        a = "x-active",
        f = "x-action",
        l = {};
    if (Modernizr.touch) {
        e(u).data(f, 0);
        o.on("touchstart click", u, v);
        o.on("touchstart click", function(e) {
            e.stopPropagation()
        });
        r.on("touchstart click", m)
    } else {
        o.hoverIntent(p, d, u);
        o.on("focusin", u, p);
        o.on("focusout", u, d)
    }
    var g = e(".mobile .x-nav"),
        y = g.find("li.menu-item-has-children > a"),
        b = g.find(".sub-menu");
    y.each(function(t) {
        e(this).append('<div class="x-sub-toggle" data-toggle="collapse" data-target=".sub-menu.sm-' + t + '"><span><i class="x-icon x-icon-angle-double-down"></i></span></div>')
    });
    b.each(function(t) {
        e(this).addClass("sm-" + t + " collapse")
    });
    e(".x-sub-toggle").on("click", function(t) {
        t.preventDefault();
        e(this).toggleClass(a).closest("li").toggleClass(a)
    });
    ...
    var w = e(".x-btn-navbar-search"),
        E = e(".x-searchform-overlay"),
        S = E.find(".form-search"),
        x = E.find(".search-query"),
        T = 27;
    w.click(function(e) {
        e.preventDefault();
        E.toggleClass("in");
    ...
    E.click(function(t) {
        e(t.target).hasClass("search-query") || N()
    });
    e(document).keydown(function(e) {
        e.which === T && E.hasClass("in") && N()
    });
    e("body").on("click", ".x-iso-container .flex-direction-nav a", function() {
        setTimeout(function() {
            t.smartresize()
        }, 750)
    });
    e("body.x-masonry-active").on("keyup", function(e) {
        e.which >= 37 && e.which <= 40 && setTimeout(function() {
            t.smartresize()
        }, 750)
    });
...
(function() {
    ...
    function da(e) {
        ...
        if (e.hasChildNodes()) {
            ...
            e = e.childNodes;
            i = 0;
            for (s = e.length; i < s; i++) n = e[i], r = n.nodeName.toLowerCase(), "source" === r ? t.sources.push(u.xb(n)) : "track" === r && t.tracks.push(u.xb(n))
        }
        return t
    }
    ...
    u.d = function(e, t, n) {
        ...
        r.T || (r.disabled = l, r.T = function(t) {
            if (!r.disabled) {
                ...
                var n = r.z[t.type];
                if (n)
                    for (var n = n.slice(0), i = 0, s = n.length; i < s && !t.nc(); i++) n[i].call(e, t)
            }
        });
            ...
            if (r.z)
                if (t) {
                    ...
                    if (i) {
                        if (n) {
                            if (n.u)
                                for (r = 0; r < i.length; r++) i[r].u === n.u && i.splice(r--, 1)
                        } else r.z[t] = [];
                        u.ec(e, t)
                    }
                } else
                    for (i in r.z) t = i, r.z[t] = [], u.ec(e, t)
        }
    };
    u.ec = function(e, t) {
        var n = u.getData(e);
    ...
    u.k = function(e, t) {
        ...
        n.T && n.T.call(e, t);
        if (r && !t.Cb()) u.k(r, t);
        else if (!r && !t.Ab() && (n = u.getData(t.target), t.target[t.type])) {
            n.disabled = f;
    ...
    u.i.gc = function(e, t) {
        var n, r, i;
        e = u.i.copy(e);
        for (n in t) w.call(t, n) && (r = e[n], i = t[n], e[n] = u.i.oc(r) && u.i.oc(i) ? u.i.gc(r, i) : t[n]);
        return e
    };
    u.i.copy = function(e) {
        return u.i.B({}, e)
    ...
    u.w = function(e, t) {
        if (-1 != e.className.indexOf(t)) {
            for (var n = e.className.split(" "), r = n.length - 1; 0 <= r; r--) n[r] === t && n.splice(r, 1);
            e.className = n.join(" ")
        }
    };
    u.ma = u.e("video");
    ...
    u.xb = function(e) {
        ...
        if (e && e.attributes && 0 < e.attributes.length)
            for (var n = e.attributes, r, i, s = n.length - 1; 0 <= s; s--) {
                r = n[s].name;
                i = n[s].value;
    ...
    t.src = function(e) {
        if (e instanceof Array) {
            ...
            t ? (e = t.source, t = t.h, t == this.ya ? this.src(e) : H(this, t, e)) : this.b.appendChild(u.e("p", {
                innerHTML: 'Sorry, no compatible source and playback technology were found for this video. Try using another browser like <a href="http://www.google.com/chrome/">Chrome</a> or download the latest <a href="http://adobe.ly/mwfN1">Adobe Flash Player</a>.'
            }))
    ...
    u.fa.prototype.update = function() {
        ...
        for (e = 0; 4 > e; e++) u.w(this.b, "vjs-vol-" + e);
    ...
    u.m = u.q.extend({
        g: function(e, t, n) {
            ...
            this.d("click", this.n);
            for (e = u.m.$a.length - 1; 0 <= e; e--) u.d(this.b, u.m.$a[e], u.bind(this.a, this.Pc));
            this.Ta()
        }
    });
    t = u.m.prototype;
    ...
    t.update = function() {
        if (0 < this.ha.length) {
            ...
            if (this.Lb === b || e < this.Lb || this.La <= e) {
                ...
                for (;;) {
                    a = t[c];
                    if (a.sa <= e) r = Math.max(r, a.sa), a.Ga && (a.Ga = l);
    ...
    u.cb.prototype.update = function() {
        for (var e = U(this.a), t = 0, n = e.length, r, i = f; t < n; t++) r = e[t], r.K() == this.ca.K() && 2 == r.mode() && (i = l);
        this.selected(i)
    };
    u.W = u.ea.extend({
        g: function(e, t) {
    ...
    u.W.prototype.sb = function() {
        ...
        for (var n = 0; n < U(this.a).length; n++) t = U(this.a)[n], t.K() === this.A && e.push(new u.X(this.a, {
            track: t
        }));
        return e
    };
    ...
    t.sb = function() {
        for (var e = [], t, n = 0; n < U(this.a).length; n++) t = U(this.a)[n], t.K() === this.A && e.push(new u.X(this.a, {
            track: t
        }));
        return e
    };
    t.Ja = function() {
        ...
        if (i) {
            r = i.ha;
            for (var o, t = 0, n = r.length; t < n; t++) o = r[t], o = new u.Xa(this.a, {
                track: i,
                cue: o
            }), s.push(o), e.Y(o)
        }
