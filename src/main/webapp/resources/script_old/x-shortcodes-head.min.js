...
! function(t, e, i) {
    "use strict";
    t.fn.backstretch = function(o, n) {
        return (o === i || 0 === o.length) && t.error("No images were supplied for Backstretch"), 0 === t(e).scrollTop() && e.scrollTo(0, 0), this.each(function() {
            var e = t(this),
                i = e.data("backstretch");
            if (i) {
                if ("string" == typeof o && "function" == typeof i[o]) return void i[o](n);
                n = t.extend(i.options, n), i.destroy(!0)
            }
            i = new s(this, o, n), e.data("backstretch", i)
        })
    ...
    var o = {
        ...
        s = function(i, s, r) {
            this.options = t.extend({}, t.fn.backstretch.defaults, r || {}), this.images = t.isArray(s) ? s : [s], t.each(this.images, function() {
                t("<img />")[0].src = this
            }), this.isBody = i === document.body, this.$container = t(i), this.$root = this.isBody ? t(n ? e : document) : this.$container;
            var l = this.$container.children(".backstretch").first();
            if (this.$wrap = l.length ? l : t('<div class="backstretch"></div>').css(o.wrap).appendTo(this.$container), !this.isBody) {
                var a = this.$container.css("position"),
                    d = this.$container.css("zIndex");
                this.$container.css({
    ...
    s.prototype = {
        resize: function() {
            try {
                ...
                r >= n ? (t = (r - n) / 2, this.options.centeredY && (i.top = "-" + t + "px")) : (r = n, s = r * this.$img.data("ratio"), t = (s - o) / 2, this.options.centeredX && (i.left = "-" + t + "px")), this.$wrap.css({
                    width: o,
                    height: n
        ...
        show: function(e) {
            if (!(Math.abs(e) > this.images.length - 1)) {
                ...
                return i.$container.trigger(t.Event("backstretch.before", n), [i, e]), this.index = e, clearInterval(i.interval), i.$img = t("<img />").css(o.img).bind("load", function(o) {
                    var r = this.width || t(o.target).width(),
                        l = this.height || t(o.target).height();
                    t(this).data("ratio", r / l), t(this).fadeIn(i.options.speed || i.options.fade, function() {
    ...
    var n = function() {
        var t = navigator.userAgent,
            ...
            o = t.match(/AppleWebKit\/([0-9]+)/),
            s = !!o && o[1],
            n = t.match(/Fennec\/([0-9]+)/),
            r = !!n && n[1],
            l = t.match(/Opera Mobi\/([0-9]+)/),
            a = !!l && l[1],
            d = t.match(/MSIE ([0-9]+)/),
            c = !!d && d[1];
        return !((i.indexOf("iPhone") > -1 || i.indexOf("iPad") > -1 || i.indexOf("iPod") > -1) && s && 534 > s || e.operamini && "[object OperaMini]" === {}.toString.call(e.operamini) || l && 7458 > a || t.indexOf("Android") > -1 && s && 533 > s || r && 6 > r || "palmGetResource" in e && s && 534 > s || t.indexOf("MeeGo") > -1 && t.indexOf("NokiaBrowser/8.5.0") > -1 || c && 6 >= c)
    }()
        ...
        function l(t, e, o) {
            for (var n in t) {
                var r = e[t[n]];
                if (r !== i) return o === !1 ? t[n] : s(r, "function") ? r.bind(o || e) : r
            }
            return !1
        }
        ...
        function a(t, e, i) {
            var o = t.charAt(0).toUpperCase() + t.slice(1),
                n = (t + " " + T.join(o + " ") + o).split(" ");
            return s(e, "string") || s(e, "undefined") ? r(n, e) : (n = (t + " " + $.join(o + " ") + o).split(" "), l(n, e, i))
        }
        var d, c, p, u = "2.8.0",
            h = {},
            f = !0,
            ...
            C = b.slice,
            x = function(t, i, o, s) {
                var n, r, l, a, d = e.createElement("div"),
                    c = e.body,
                    p = c || e.createElement("body");
                if (parseInt(o, 10))
                    for (; o--;) l = e.createElement("div"), l.id = s ? s[o] : y + (o + 1), d.appendChild(l);
                return n = ["&#173;", '<style id="s', y, '">', t, "</style>"].join(""), d.id = y, (c ? d : p).innerHTML += n, p.appendChild(d), c || (p.style.background = "", p.style.overflow = "hidden", a = v.style.overflow, v.style.overflow = "hidden", v.appendChild(p)), r = i(d, t), c ? d.parentNode.removeChild(d) : (p.parentNode.removeChild(p), v.style.overflow = a), !!r
            },
            P = function() {
                function t(t, n) {
                    n = n || e.createElement(o[t] || "div"), t = "on" + t;
                    var r = t in n;
                    return r || (n.setAttribute || (n = e.createElement("div")), n.setAttribute && n.removeAttribute && (n.setAttribute(t, ""), r = s(n[t], "function"), s(n[t], "undefined") || (n[t] = i), n.removeAttribute(t))), n = null, r
                }
                var o = {
                    select: "input",
                    change: "input",
            ...
            O = {}.hasOwnProperty;
        p = s(O, "undefined") || s(O.call, "undefined") ? function(t, e) {
            ...
            var i = C.call(arguments, 1),
                o = function() {
                    if (this instanceof o) {
                        ...
                        var n = new s,
                            r = e.apply(n, i.concat(C.call(arguments)));
            ...
            var i;
            return "ontouchstart" in t || t.DocumentTouch && e instanceof DocumentTouch ? i = !0 : x(["@media (", k.join("touch-enabled),("), y, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(t) {
                i = 9 === t.offsetTop
            }), i
            ...
            var t = !!a("perspective");
            return t && "webkitPerspective" in v.style && x("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(e) {
                t = 9 === e.offsetLeft && 3 === e.offsetHeight
            }), t
        }, S.csstransitions = function() {
            return a("transition")
        };
        for (var j in S) p(S, j) && (c = j.toLowerCase(), h[c] = S[j](), b.push((h[c] ? "" : "no-") + c));
        return h.addTest = function(t, e) {
            if ("object" == typeof t)
                for (var o in t) p(t, o) && h.addTest(o, t[o]);
            else {
                if (t = t.toLowerCase(), h[t] !== i) return h;
                e = "function" == typeof e ? e() : e, "undefined" != typeof f && f && (v.className += " " + (e ? "" : "no-") + t), h[t] = e
            }
            return h
        }, o(""), m = d = null, h._version = u, h._prefixes = k, h._domPrefixes = $, h._cssomPrefixes = T, h.hasEvent = P, h.testProp = function(t) {
            return r([t])
        }, h.testAllProps = a, h.testStyles = x, h.prefixed = function(t, e, i) {
            return e ? a(t, e, i) : a(t, "pfx")
        }, v.className = v.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + b.join(" ") : ""), h
    }(this, this.document),
    function(t, e, i) {
        function o(t) {
        ...
        function l() {
            var t = m.shift();
            g = 1, t ? t.t ? f(function() {
                ("c" == t.t ? u.injectCss : u.injectJs)(t.s, 0, t.a, t.x, t.e, 1)
            }, 0) : (t(), l()) : g = 0
        }

        function a(t, i, o, s, n, a, d) {
            function c(e) {
                if (!h && r(p.readyState) && (k.r = h = 1, !g && l(), p.onload = p.onreadystatechange = null, e)) {
                    "img" != t && f(function() {
                        T.removeChild(p)
                    }, 50);
            ...
            1 === x[i] && (y = 1, x[i] = []), "object" == t ? p.data = i : (p.src = i, p.type = t), p.width = p.height = "0", p.onerror = p.onload = p.onreadystatechange = function() {
                c.call(this, y)
            }, m.splice(s, 0, k), "img" != t && (y || 2 === x[i] ? (T.insertBefore(p, w ? null : v), f(c, d)) : x[i].push(p))
        }

        function d(t, e, i, o, n) {
            return g = 0, e = e || "j", s(t) ? a("c" == e ? S : $, t, e, this.i++, i, o, n) : (m.splice(this.i++, 0, t), 1 == m.length && l()), this
        }
        ...
        var p, u, h = e.documentElement,
            ...
            w = k && !!e.createRange().compareNode,
            T = w ? h : v.parentNode,
            h = t.opera && "[object Opera]" == y.call(t.opera),
            h = !!e.attachEvent && !h,
            $ = k ? "object" : h ? "script" : "img",
            S = h ? "script" : $,
        ...
        u = function(t) {
            function e(t) {
                ...
                for (i = 0; r > i; i++) o = t[i].split("="), (e = P[o.shift()]) && (n = e(n, o));
                for (i = 0; s > i; i++) n = C[i](n);
                return n
            }

            function r(t, s, n, r, l) {
                var a = e(t),
                    d = a.autoCallback;
                a.url.split(".").pop().split("?").shift(), a.bypass || (s && (s = o(s) ? s : s[t] || s[r] || s[t.split("/").pop().split("?")[0]]), a.instead ? a.instead(t, s, n, r, l) : (x[a.url] ? a.noexec = !0 : x[a.url] = 1, n.load(a.url, a.forceCSS || !a.forceJS && "css" == a.url.split(".").pop().split("?").shift() ? "c" : i, a.noexec, a.attrs, a.timeout), (o(s) || o(d)) && n.load(function() {
                    c(), s && s(a.origUrl, l, r), d && d(a.origUrl, l, r), x[a.url] = 2
                })))
            }
            ...
            function l(t, e) {
                    ...
                    if (t) {
                        if (s(t)) i || (p = function() {
                            ...
                            for (a in l = function() {
                                    ...
                                    return i
                                }(), t) t.hasOwnProperty(a) && (!i && !--l && (o(p) ? p = function() {
                                var t = [].slice.call(arguments);
                                u.apply(this, t), h()
                            } : p[a] = function(t) {
                                return function() {
                ...
                var l, a, d = !!t.test,
                    ...
                    u = p,
                    h = t.complete || n;
                i(d ? t.yep : t.nope, !!c), c && i(c)
            }
            var a, d, p = this.yepnope.loader;
            if (s(t)) r(t, 0, p, 0);
            else if (b(t))
                for (a = 0; a < t.length; a++) d = t[a], s(d) ? r(d, 0, p, 0) : b(d) ? u(d) : Object(d) === d && l(d, p);
            else Object(t) === t && l(t, p)
        }, u.addPrefix = function(t, e) {
            P[t] = e
        }, u.addFilter = function(t) {
            C.push(t)
        }, u.errorTimeout = 1e4, null == e.readyState && e.addEventListener && (e.readyState = "loading", e.addEventListener("DOMContentLoaded", p = function() {
            e.removeEventListener("DOMContentLoaded", p, 0), e.readyState = "complete"
        }, 0)), t.yepnope = c(), t.yepnope.executeStack = l, t.yepnope.injectJs = function(t, i, o, s, a, d) {
            var c, p, h = e.createElement("script"),
                s = s || u.errorTimeout;
            h.src = t;
            for (p in o) h.setAttribute(p, o[p]);
            i = d ? l : i || n, h.onreadystatechange = h.onload = function() {
                !c && r(h.readyState) && (c = 1, i(), h.onload = h.onreadystatechange = null)
            }, f(function() {
                c || (c = 1, i(1))
            }, s), a ? h.onload() : v.parentNode.insertBefore(h, v)
        }, t.yepnope.injectCss = function(t, i, o, s, r, a) {
            var d, s = e.createElement("link"),
                i = a ? l : i || n;
            s.href = t, s.rel = "stylesheet", s.type = "text/css";
            for (d in o) s.setAttribute(d, o[d]);
            r || (v.parentNode.insertBefore(s, v), f(i, 0))
        }
    ...
    function(t) {
        t.fn.fitText = function(e, i) {
            ...
            return this.each(function() {
                var e = t(this),
                    i = function() {
                        e.css("font-size", Math.max(Math.min(e.width() / (10 * o), parseFloat(s.maxFontSize)), parseFloat(s.minFontSize)))
                    };
    ...
    function(t) {
        ...
        e = function() {
            function e(e, o) {
                ...
                r.autoPlay = t.proxy(r.autoPlay, r), r.autoPlayClear = t.proxy(r.autoPlayClear, r), r.changeSlide = t.proxy(r.changeSlide, r), r.setPosition = t.proxy(r.setPosition, r), r.swipeHandler = t.proxy(r.swipeHandler, r), r.dragHandler = t.proxy(r.dragHandler, r), r.keyHandler = t.proxy(r.keyHandler, r), r.autoPlayIterator = t.proxy(r.autoPlayIterator, r), r.instanceUid = i++, r.init()
            }
            var i = 0;
            return e
            ...
            s.unload(), "number" == typeof i ? 0 === i && 0 === s.$slides.length ? t(e).appendTo(s.$slideTrack) : o ? t(e).insertBefore(s.$slides.eq(i)) : t(e).insertAfter(s.$slides.eq(i)) : o === !0 ? t(e).prependTo(s.$slideTrack) : t(e).appendTo(s.$slideTrack), s.$slides = s.$slideTrack.children(this.options.slide), s.$slideTrack.children(this.options.slide).remove(), s.$slideTrack.append(s.$slides), s.$slidesCache = s.$slides, s.reinit()
            ...
            if (o.options.dots === !0 && o.slideCount > o.options.slidesToShow) {
                for (i = '<ul class="slick-dots">', e = 0; e <= o.getDotCount(); e += 1) i += "<li>" + o.options.customPaging.call(this, o, e) + "</li>";
                i += "</ul>", o.$dots = t(i).appendTo(o.$slider), o.$dots.find("li").first().addClass("slick-active")
            }
            ...
            if (o.originalSettings.responsive && o.originalSettings.responsive.length > -1 && null !== o.originalSettings.responsive) {
                ...
                null !== i ? null !== o.activeBreakpoint ? i !== o.activeBreakpoint && (o.activeBreakpoint = i, o.options = t.extend({}, o.defaults, o.breakpointSettings[i]), o.refresh()) : (o.activeBreakpoint = i, o.options = t.extend({}, o.defaults, o.breakpointSettings[i]), o.refresh()) : null !== o.activeBreakpoint && (o.activeBreakpoint = null, o.options = t.extend({}, o.defaults, o.originalSettings), o.refresh())
            }
            ...
            var t, e = this,
                ...
                o = 0,
                s = 0;
            for (t = e.options.infinite === !0 ? e.slideCount + e.options.slidesToShow - e.options.slidesToScroll : e.slideCount; t > i;) s++, o += e.options.slidesToScroll, i = o + e.options.slidesToShow;
            return s
        }, e.prototype.getLeft = function(t) {
            var e, i, o = this,
                s = 0;
            return o.slideOffset = 0, i = o.$slides.first().outerHeight(), o.options.infinite === !0 ? (o.slideCount > o.options.slidesToShow && (o.slideOffset = o.slideWidth * o.options.slidesToShow * -1, s = i * o.options.slidesToShow * -1), o.slideCount % o.options.slidesToScroll !== 0 && t + o.options.slidesToScroll > o.slideCount && o.slideCount > o.options.slidesToShow && (o.slideOffset = o.slideCount % o.options.slidesToShow * o.slideWidth * -1, s = o.slideCount % o.options.slidesToShow * i * -1)) : o.slideCount % o.options.slidesToShow !== 0 && t + o.options.slidesToScroll > o.slideCount && o.slideCount > o.options.slidesToShow && (o.slideOffset = o.options.slidesToShow * o.slideWidth - o.slideCount % o.options.slidesToShow * o.slideWidth, s = o.slideCount % o.options.slidesToShow * i), o.options.centerMode === !0 && (o.slideOffset += o.slideWidth * Math.floor(o.options.slidesToShow / 2) - o.slideWidth), e = o.options.vertical === !1 ? t * o.slideWidth * -1 + o.slideOffset : t * i * -1 + s
            ...
            var e, i, o, s, n = this;
            n.options.centerMode === !0 ? (o = n.options.slidesToShow + n.currentSlide - 1, s = o + n.options.slidesToShow + 2) : (o = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, s = o + n.options.slidesToShow), e = n.$slider.find(".slick-slide").slice(o, s), t("img[data-lazy]", e).not("[src]").each(function() {
                t(this).css({
                    opacity: 0
            ...
            var e, i, o = this;
            e = t("img[data-lazy]").not("[src]").length, e > 0 && (i = t(t("img[data-lazy]", o.$slider).not("[src]").get(0)), i.attr("src", i.attr("data-lazy")).removeClass("slick-loading").load(function() {
            ...
            var e, i, o = this,
                s = {};
            e = "left" == o.positionProp ? t + "px" : "0px", i = "top" == o.positionProp ? t + "px" : "0px", s[o.positionProp] = t, o.transformsEnabled === !1 ? o.$slideTrack.css(s) : (s = {}, o.cssTransitions === !1 ? (s[o.animType] = "translate(" + e + ", " + i + ")", o.$slideTrack.css(s)) : (s[o.animType] = "translate3d(" + e + ", " + i + ", 0px)", o.$slideTrack.css(s)))
            ...
            var e, i, o, s = this;
            s.$slider.find(".slick-slide").removeClass("slick-active").removeClass("slick-center"), i = s.$slider.find(".slick-slide"), s.options.centerMode === !0 ? (e = Math.floor(s.options.slidesToShow / 2), t >= e && t <= s.slideCount - 1 - e ? s.$slides.slice(t - e, t + e + 1).addClass("slick-active") : (o = s.options.slidesToShow + t, i.slice(o - e + 1, o + e + 2).addClass("slick-active")), 0 === t ? i.eq(i.length - 1 - s.options.slidesToShow).addClass("slick-center") : t === s.slideCount - 1 && i.eq(s.options.slidesToShow).addClass("slick-center"), s.$slides.eq(t).addClass("slick-center")) : t > 0 && t < s.slideCount - s.options.slidesToShow ? s.$slides.slice(t, t + s.options.slidesToShow).addClass("slick-active") : (o = s.options.infinite === !0 ? s.options.slidesToShow + t : t, i.slice(o, o + s.options.slidesToShow).addClass("slick-active")), "ondemand" === s.options.lazyLoad && s.lazyLoad()
            ...
            if ((s.options.fade === !0 || s.options.vertical === !0) && (s.options.centerMode = !1), s.options.infinite === !0 && s.options.fade === !1 && (i = null, s.slideCount > s.options.slidesToShow)) {
                for (o = s.options.centerMode === !0 ? s.options.slidesToShow + 1 : s.options.slidesToShow, e = s.slideCount; e > s.slideCount - o; e -= 1) i = e - 1, t(s.$slides[i]).clone().attr("id", "").prependTo(s.$slideTrack).addClass("slick-cloned");
                for (e = 0; o > e; e += 1) i = e, t(s.$slides[i]).clone().attr("id", "").appendTo(s.$slideTrack).addClass("slick-cloned");
            ...
            var e, i, o, s, n = this;
            return s = void 0 !== t.originalEvent ? t.originalEvent.touches : null, e = n.getLeft(n.currentSlide), !n.$list.hasClass("dragging") || s && 1 !== s.length ? !1 : (n.touchObject.curX = void 0 !== s ? s[0].pageX : t.clientX, n.touchObject.curY = void 0 !== s ? s[0].pageY : t.clientY, n.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(n.touchObject.curX - n.touchObject.startX, 2))), i = n.swipeDirection(), "vertical" !== i ? (void 0 !== t.originalEvent && n.touchObject.swipeLength > 4 && t.preventDefault(), o = n.touchObject.curX > n.touchObject.startX ? 1 : -1, n.swipeLeft = n.options.vertical === !1 ? e + n.touchObject.swipeLength * o : e + n.touchObject.swipeLength * (n.$list.height() / n.listWidth) * o, n.options.fade === !0 || n.options.touchMove === !1 ? !1 : n.animating === !0 ? (n.swipeLeft = null, !1) : void n.setCSS(n.swipeLeft)) : void 0)
